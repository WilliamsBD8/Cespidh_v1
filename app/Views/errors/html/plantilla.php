            ...
            <div class="section section-404 p-0 m-0 height-100vh">
                <div class="row">
                    ...
                    <div class="col s12 center-align white">
                        ...
                        <h4 class="m-0 pb-2">Este documento no cuenta con una plantilla</h4>
                        <a href="<?= base_url(['cespidh', 'ciudadanos']); ?>" class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4">
                            Regresar</a>
                    </div>
                </div>
            </div>
