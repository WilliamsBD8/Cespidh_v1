...
class DocumentController extends BaseController
{
  public function create(){
    ...
    $userModel = new User();
    $user = $userModel->where(['cedula' => $id])->get()->getResult();
    ...
    $workM->insert(['observation' => 'Creación del documento', 'documento_id_documento' => $id_documento, 'users_id' => $id_user, 'work_type_id' => 1]);
    // $id_documento = 1;
...
public function view_document($id, $type){
    ...
    if(!empty($documento[0]) && ($type == 1 || $type == 2 || $type == 3)){
